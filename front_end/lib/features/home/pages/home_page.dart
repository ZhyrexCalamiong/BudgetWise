              ...
              Row(
                ...
                children: [
                  _buildIconButton(Icons.add, 'Add', () {
                    _showAddMoneyDialog(
                        context); // Show the dialog box when the button is pressed
                  }),
                  const SizedBox(width: 20),
                  _buildIconButton(Icons.shopping_cart, 'Buy', () {}),
                  const SizedBox(width: 20),
                  _buildIconButton(Icons.transform, 'Convert', () {
                    _showMoneyConverterDialog(context);
                  }),
                ],
              ),
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                    filled: true,
                    fillColor:
                        const Color(0xFF1E1E1E), // Input background color
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    const SizedBox(
                        width:
                            10), // Spacing between dropdown and output text field
                    Expanded(
                      child: TextField(
