...
class MoneyConverterBloc extends Bloc<MoneyConverterEvent, MoneyConverterState> {
  final MoneyConverterRepository _moneyConverterRepository;

  MoneyConverterBloc(this._moneyConverterRepository) : super(MoneyConverterInitial()) {
    on<ConvertCurrencyEvent>((event, emit) async {
      ...
      try {
        ...
        emit(MoneyConverterError("Failed to convert currency."));
      }
    });
  }
}
